...
***BE SURE TO REMOVE THE $VIEW PROPERTY GENERATED BY YOUR NEW PAGE. IT OVERRIDES THE LIBRARY'S VIEW PROPERTY***
...
{
    /*
     * REMOVE THE AUTOGENERATED $view PROPERTY OR CONTENT WON'T RENDER
     */
     //    protected static string $view = 'filament.pages.custom-page'; <- DELETE THIS
